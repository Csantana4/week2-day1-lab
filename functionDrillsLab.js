...
console.log(exclaimThree('Lets Go!'))
...
} let namegreeting = checkName('Bryan')
...
function faveColorFinder(x){
  if(x === 'red'){
    ...
    return'green is a olid favorite color'
  } else if(x === black){
    return 'so trendy'
  } else{
...
let contestantsLeft = theEliminator(contestants, loser)
console.log(contestantsLeft)
...
function emailCheck(x){
  let email = String(x).trim() 
    if(email.includes('@') ===true){
      ...
      return 'must provide a valid eamil address'
    }
  } 
  console.log(emailCheck('christiansantana@gmail.com'))
...
//CODE HERE
function goldForFrogs(x){
  return x/3
} let totalFrogs = goldForFrogs(4)
console.log(`I can buy ${totalFrogs} chocoalte frogs `)
...
//CODE HERE
function goldForFrogs2(x){
  return x/3
} let totalFrogs2 = goldForFrogs(3)
console.log(`I can buy ${totalFrogs2} chocoalte frogs `)
